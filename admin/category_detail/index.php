<?php
    ...
    order by category_detail.id desc
        ...
        <div class="main__container">
            <div class="container-fluid px-4">
                <form action="process_insert.php" method="post" enctype="multipart/form-data" class="col-4">
                    <h2 class="text-center">Thêm thể loại phụ</h2>
                    <div class="mb-4 fs-4">
                        <label class="form-label" for="name">Thể loại chính</label>
                    ...
                    <div class="col-12">
                        <table class="category__table table table-sm table-bordered table-hover align-middle">
                            <thead>
                                ...
                                <th scope="col">Thể loại chính</th>
                                <th scope="col">Sửa</th>
                                <th scope="col">Xóa</th>
                                </tr>
                            </thead>
